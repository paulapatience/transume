...
(uiop:define-package #:transume/contrib/generate-documentation
  (:documentation "Generate documentation based on MGL-PAX.
See @TRANSUME-CONTRIB-GENERATE-DOCUMENTATION.")
  (:use #:common-lisp)
  (:import-from #:pathname-utils)
  (:import-from #:mgl-pax))
(in-package #:transume/contrib/generate-documentation)

;;;* Documentation

(pax:defsection @transume-contrib-generate-documentation
...
(transume/contrib/generate-documentation:generate
 transume/contrib/generate-documentation::@transume-contrib-generate-documentation
        ...
        (concatenate 'string "--lua-filter="
                     (pathname-utils:native-namestring
                      (asdf:system-relative-pathname
                       "transume" "contrib/mgl-pax-filter.lua"))))
